                ...
                <div class="card d-flex">
                    <div class="document-item">
                        ...
                        <div class="item-detail">
                            ...
                            <small class="ml-3 text-capitalize">Dated Added: {{ report.createdAt}}</small>
                            <!-- <router-link class="mt-3 btn btn-primary btn-sm ml-2" :to="`/reports/${report._id}`" >View</router-link> -->
                        </div>
                    </div>
                </div>
            </b-list-group>
